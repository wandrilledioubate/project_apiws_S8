...
export default function Products() {
    ...
    const getProducts = async (e) => {
        ...
        try {
            const res = await fetch(process.env.REACT_APP_CURRENT_USER_URL+`/products`, {
                method: "GET",
                headers: {
    ...
    const deleteProduct = async (id) => {
        ...
        const response = await fetch(process.env.REACT_APP_CURRENT_USER_URL+`/deleteproduct/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            }
